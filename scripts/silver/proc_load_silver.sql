...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '================================================';
        PRINT 'Loading Silver Layer (CRM + ERP + API)';
        PRINT '================================================';
...
-- ========================
-- API: silver.api_sales_details
-- ========================
SET @start_time = GETDATE();
PRINT '>> Truncating Table: silver.api_sales_details';
TRUNCATE TABLE silver.api_sales_details;
PRINT '>> Inserting Data Into: silver.api_sales_details';
INSERT INTO silver.api_sales_details (
